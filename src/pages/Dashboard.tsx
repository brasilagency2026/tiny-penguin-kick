      ...
      <div className="min-h-screen flex items-center justify-center bg-slate-50 px-4">
        <Card className="w-full max-w-md border-none shadow-2xl rounded-[2rem]">
          <CardHeader className="text-center pt-10">
            ...
            <CardDescription>Digite sua senha de administrador para continuar.</CardDescription>
          </CardHeader>
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          {[
            ...
            { title: 'Visualizações', value: stats.views.toLocaleString(), icon: <Eye />, color: 'text-purple-500' },
